...
class _GithubUsersState extends State<GithubUsers> {
    ...
    try {
      var response = await Dio().get("https://api.github.com/users", 
        options: Options(headers: {
          "Authorization": "token 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", // your github access token
      }));
  ...
  void _launchURL(String _url) async =>
    await canLaunchUrl(Uri.parse(_url)) ? await launchUrl(Uri.parse(_url)) : throw 'Could not launch $_url';
}
